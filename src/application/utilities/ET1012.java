...
public class ET1012 implements
        ...
        return new TableCell<Map<String, String>, Map<String, String>>() {
            ...
            protected void updateItem(Map<String, String> item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    String enseignantFullName = item.get("enseignantFullName10_12");
                    String enseignantPhotoUrl = item.get("photoUrlEnseignant10_12");
                    String coursNom = item.get("coursnom10_12");
                    String schedualesInfos = item.get("nomSalle10_12") + ": 10:00 - 12:00";
