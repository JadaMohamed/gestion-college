...
public class CustomConsulterAbsenceEtudiantButton
    ...
    public CustomConsulterAbsenceEtudiantButton(ButtonClickHandler<Etudiant> buttonClickHandler) {
    ...
    public TableCell<Etudiant, String> call(TableColumn<Etudiant, String> param) {
        return new TableCell<>() {
            ...
            {
                Image icon = new Image(getClass().getResourceAsStream("/resources/images/icons/file-check-03.png"));
                ...
                button.setStyle(
                        "-fx-background-color: #DDC7FA ; -fx-cursor: Hand; -fx-padding: 5px");
