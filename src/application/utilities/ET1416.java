...
public class ET1416 implements
        ...
        return new TableCell<Map<String, String>, Map<String, String>>() {
            ...
            protected void updateItem(Map<String, String> item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    String enseignantFullName = item.get("enseignantFullName14_16");
                    String enseignantPhotoUrl = item.get("photoUrlEnseignant14_16");
                    String coursNom = item.get("coursnom14_16");
                    String schedualesInfos = item.get("nomSalle14_16") + ": 14:00 - 16:00";
